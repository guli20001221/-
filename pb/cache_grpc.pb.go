...
const (
	...
	GroupCache_Set_FullMethodName    = "/pb.GroupCache/Set"
...
func (c *groupCacheClient) Set(ctx context.Context, in *Request, opts ...grpc.CallOption) (*ResponseForGet, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ResponseForGet)
...
func (UnimplementedGroupCacheServer) Set(context.Context, *Request) (*ResponseForGet, error) {
...
func _GroupCache_Set_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GroupCacheServer).Set(ctx, req.(*Request))
	}
	return interceptor(ctx, in, info, handler)
}
